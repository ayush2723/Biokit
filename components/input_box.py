...
def dna_input_box(label="Enter DNA Sequence", height=100, max_chars=1000, placeholder="e.g. ATGCGTACGTTAGC"): #input box for DNA sequence
    dna_input = st.text_area(label, height=height, max_chars=max_chars, placeholder=placeholder) #
